...
public:
    ...
    void agregarArista(string origen, string destino, int costo, float tiempo)
    {
        ...
        nuevaArista->siguiente = listaAdyacencia[indexOrigen]; // arista anterior
    ...
    void encontrarRecorridoMinimo(string origen, string destino)
    {
        ...
        else
        {
            ...
            while (v != indexOrigen)
            {
                // Imprimir el vértice actual y la arista que conecta al predecesor
            ...
            cout << codigosVertices[v] << endl; // Imprimir el vértice de inicio
